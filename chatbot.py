...
# ======================
class Config:
    API_KEY = "AIzaSyD3Id1JDtk9ShJdA5WXbk1CvyzJRiZWybc"
    API_URL = f"https://generativelanguage.googleapis.com/v1beta/models/gemini-2.0-flash:generateContent?key={API_KEY}"
    VIP_LINK = "https://exemplo.com/vip"
    CHECKOUT_START = "https://pay.risepay.com.br/Pay/742bcb36d32345bfb54180ba418977bd"
    CHECKOUT_PREMIUM = "https://pay.risepay.com.br/Pay/1b449a36e15e43b7a5c411d4640fa473"
    CHECKOUT_EXTREME = "https://pay.risepay.com.br/Pay/380ab856b63a43ca9711482ada9ecfd6"
...
class Persona:
    ...
    Talia: adoro mostrar ela aberta
    Cliente: quero ver
    Resposta: ```json
    {
...
class UiService:
    ...
    def show_call_effect():
        ...
        ">
            ...
            <h3 style="color: #ff66b3; margin-bottom: 5px;">Ligando para Talia...</h3>
        ...
        ">
            ...
            <p style="font-size: 0.9rem; margin:0;">Talia está te esperando...</p>
        </div>
        """, unsafe_allow_html=True)
    ...
    def setup_sidebar():
        with st.sidebar:
            ...
            <div class="sidebar-header">
                <img src="{profile_img}" alt="Talia">
                <h3 style="color: #ff66b3; margin-top: 10px;">Talia Premium</h3>
            </div>
    ...
    def enhanced_chat_ui(conn):
        ...
        <div class="chat-header">
            <h2 style="margin:0; font-size:1.5em; display:inline-block;">Chat Privado com Talia</h2>
        </div>
        """, unsafe_allow_html=True)
...
class NewPages:
    ...
    def show_home_page():
        ...
        <div class="hero-banner">
            <h1 style="color: #ff66b3;">Talia Premium</h1>
    ...
    def show_offers_page():
        ...
        <div class="package-box package-start">
            <div class="package-header">
                ...
                <div class="package-price" style="color: #ff66b3;">R$19,69</div>
        ...
        <div class="package-box package-premium">
            ...
            <div class="package-header">
                ...
                <div class="package-price" style="color: #9400d3;">R$39,69</div>
        ...
        <div class="package-box package-extreme">
            <div class="package-header">
                ...
                <div class="package-price" style="color: #ff0066;">R$49,69</div>
...
class ChatService:
    ...
    def format_conversation_history(messages, max_messages=10):
        ...
        for msg in messages[-max_messages:]:
            role = "Cliente" if msg["role"] == "user" else "Talia"
            content = msg["content"]
            if content == "[ÁUDIO]":
    ...
    if not st.session_state.chat_started:
        ...
        with col2:
            ...
            <div style="text-align: center; margin: 50px 0;">
                ...
                <h2 style="color: #ff66b3; margin-top: 15px;">Talia</h2>
